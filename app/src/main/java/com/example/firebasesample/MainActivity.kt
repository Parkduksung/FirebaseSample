...
//        FirebaseRemoteDataSourceImpl().createUser("duksung1131@naver.com", "11111111") {
//            Log.d("결과", it.toString())
//        }


//        FirebaseRemoteDataSourceImpl().addData("User", UserDTO("덕성", "부천")) {
//            Log.d("결과", it.toString())
//        }

//        val c = object : FirebaseRemoteDataSource<FirebaseData> {
//            override fun addData(collection: String, data: FirebaseData, isAdd: (Boolean) -> Unit) {
//                FirebaseFirestore.getInstance().collection(collection).document().set(data)
